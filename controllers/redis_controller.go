...
// +kubebuilder:rbac:groups=webapp.kops.ust-global-lab.com,resources=redis,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=webapp.kops.ust-global-lab.com,resources=redis/status,verbs=get;update;patch

...
// +kubebuilder:rbac:groups=webapp.kops.ust-global-lab.com,resources=guestbooks,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=webapp.kops.ust-global-lab.com,resources=guestbooks/status,verbs=get;update;patch
